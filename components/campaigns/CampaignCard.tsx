...
const STATUS_CONFIG = {
  Active: { label: "Active", className: "badge-active", dot: "dot-active" },
  Successful: { label: "Funded ✓", className: "badge-success", dot: "" },
  Expired: { label: "Expired", className: "badge-expired", dot: "" },
  Withdrawn: { label: "Completed", className: "badge-success", dot: "" },
};
        ...
        style={{
          background:
            campaign.status === "Successful" || campaign.status === "Withdrawn"
              ? "linear-gradient(90deg, hsl(142,70%,45%), hsl(174,80%,45%))"
              : campaign.status === "Expired"
              ? "linear-gradient(90deg, hsl(0,20%,40%), hsl(0,20%,50%))"
              : `linear-gradient(90deg, hsl(174,80%,45%) ${campaign.progressPercent}%, hsl(234,18%,20%) ${campaign.progressPercent}%)`,
        }}
      />
      ...
      <div className="p-5 flex flex-col flex-1 gap-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center justify-between text-xs text-muted-foreground">
            <span>{campaign.progressPercent.toFixed(1)}% funded</span>
            {isActive && (
