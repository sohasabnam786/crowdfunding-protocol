...
import { X, Rocket, Calendar, Target, FileText, Loader2, AlertCircle } from "lucide-react";
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-white/[0.06]">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-bold text-base">Launch Campaign</h2>
              <p className="text-xs text-muted-foreground">Create a new crowdfunding campaign</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                id="campaign-title"
                type="text"
                placeholder="e.g. Build a Solar Farm in Rural Kenya"
                value={form.title}
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              id="campaign-desc"
              placeholder="Describe your project, what you'll build, and how funds will be used..."
