...
export const metadata: Metadata = {
  title: "CrowdFund Protocol | Decentralized Crowdfunding on Stellar",
  description:
    "Launch and fund campaigns on the Stellar blockchain. Transparent, fast, and low-cost crowdfunding powered by Soroban smart contracts.",
  keywords: [
    "Stellar",
    "Soroban",
    "crowdfunding",
