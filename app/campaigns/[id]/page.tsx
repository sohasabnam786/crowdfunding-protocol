          ...
          <div className="glass-card p-6 md:p-8 space-y-6">
            <div className="flex flex-wrap items-center gap-2.5">
              ...
              >
                ...
                {campaign.status === "Withdrawn" ? "Completed" : campaign.status}
              </span>
            ...
            <div className="space-y-3 pt-4 border-t border-white/[0.05]">
              <div className="flex items-baseline justify-between">
                <div>
                  ...
                  <span className="text-sm text-muted-foreground ml-2">
                    raised of {formatXlm(campaign.goal, 0)}
                  </span>
                </div>
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 text-xs text-muted-foreground pt-1">
                <span className="flex items-center gap-1.5">
                  ...
                  {donations?.length || 0} Backers
                </span>
                {campaign.status === "Active" && (
                  <span className="flex items-center gap-1.5">
                    <Clock className="w-3.5 h-3.5" />
                    Deadline: {campaign.deadline.toLocaleDateString("en-US", {
                      month: "long",
                      day: "numeric",
                      year: "numeric",
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-xl bg-white/[0.02] border border-white/[0.05] text-xs">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-muted-foreground font-medium">Campaign Creator</p>
            ...
            {canWithdraw && (
              <div className="p-5 rounded-xl bg-primary/5 border border-primary/20 space-y-4">
                <div>
                  <h3 className="font-bold text-sm text-primary">Creator Panel</h3>
                  <p className="text-xs text-muted-foreground mt-0.5">
                    Funding goal achieved! Withdraw {formatXlm(campaign.raised)} to your wallet.
                  </p>
                </div>
                <button
                ...
                >
                  {isWithdrawing ? (
                    ...
                    <>
                      ...
                      <span>Withdraw {formatXlm(campaign.raised, 0)}</span>
                    </>
                  )}
                </button>
              </div>
          ...
          <div className="glass-card p-5 space-y-3.5">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1 leading-relaxed">
                This campaign is managed by a Soroban smart contract on the Stellar blockchain. 
