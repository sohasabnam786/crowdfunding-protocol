        ...
        <div className="glass-card p-12 flex flex-col items-center gap-6 text-center">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground max-w-sm">
              Connect a Stellar wallet to view your balance, create campaigns,
              and donate to projects on the Stellar Testnet.
            </p>
          </div>
          <button
            ...
            {recentTxs.length === 0 ? (
              <div className="text-center py-8">
                <p className="text-muted-foreground text-sm">
                  No transactions yet. Create a campaign or make a donation to
                  get started.
                </p>
              </div>
            ) : (
